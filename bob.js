...
const geocoding = () => {
	...
	const countryCodeVal = countryCode.value;

	fetch(
		`https://api.openweathermap.org/geo/1.0/direct?q=${cityNameVal},${countryCodeVal}&limit=3&appid=4e85da042ac14ae79aeecba8f5d02749`
	)
		...
		.then((response) => {
			...
			return fetch(
				`https://api.openweathermap.org/data/2.5/weather?lat=${latitude}&lon=${longitude}&appid=4e85da042ac14ae79aeecba8f5d02749`
			);
		})
		.then((response) => response.json())
		.then((response) => {
